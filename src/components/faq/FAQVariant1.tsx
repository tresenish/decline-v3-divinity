/**
 * FAQ — Clean modern accordion design.
 */
...
const FAQVariant1: React.FC = () => {
  ...
  return (
    <Section id="faq">
      <Inner>
        <Header>
          <Title>{faq.sectionTitle}</Title>
          <Desc>{faq.sectionDescription}</Desc>
        </Header>
        <FAQList>
            ...
            return (
              <Item key={index} className="slide-child">
                <Question
                  ...
                  aria-expanded={open}
                >
                  <QText $open={open}>{item.question}</QText>
